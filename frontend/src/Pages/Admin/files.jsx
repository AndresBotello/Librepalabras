...
export default function Files() {
  ...
  const files = [
    { id: 1, name: 'cuento_primavera.pdf', author: 'Juan Pérez', uploadDate: '2024-01-10', size: '2.4 MB', type: 'PDF' },
    { id: 2, name: 'poesia_nocturna.docx', author: 'María García', uploadDate: '2024-01-09', size: '156 KB', type: 'Word' },
    { id: 3, name: 'ensayo_libertad.pdf', author: 'Carlos Ruiz', uploadDate: '2024-01-08', size: '1.8 MB', type: 'PDF' },
    { id: 4, name: 'relato_ciudad.docx', author: 'Ana López', uploadDate: '2024-01-07', size: '234 KB', type: 'Word' },
  ];
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-6 max-w-7xl mx-auto">
              <div className="flex-1">
                ...
                <p className={`text-base transition-colors ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                  Administra todos los archivos literarios subidos a la plataforma.
                </p>
              </div>
            ...
            <div className={`rounded-lg overflow-hidden transition-colors ${isDark ? 'bg-gray-900 border border-gray-800' : 'bg-white border border-gray-200'}`}>
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    {files.map((file) => (
                      <tr key={file.id} className={isDark ? 'border-b border-gray-800 hover:bg-gray-800' : 'border-b border-gray-200 hover:bg-gray-50'}>
